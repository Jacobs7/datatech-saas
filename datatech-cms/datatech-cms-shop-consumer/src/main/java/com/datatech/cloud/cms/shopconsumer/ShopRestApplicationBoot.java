/**
 * 公  司：魔力小猪
 * 文件名：ShopRestApplicationBoot
 * 作  者：Zly
 * 时  间：2019/4/18/10:28
 */
package com.datatech.cloud.cms.shopconsumer;
...
@EnableSwagger2Doc
public class ShopRestApplicationBoot {
    public static void main(String[]args){
        SpringApplication.run(ShopRestApplicationBoot.class,args);
    }
}
