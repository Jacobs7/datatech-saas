package com.datatech.cloud.upms.server.feign;

import com.datatech.cloud.api.vo.user.UserInfo;
import com.datatech.cloud.upms.server.configuration.FeignConfiguration;
 ...
 */
@FeignClient(value = "datatech-admin",configuration = FeignConfiguration.class)
